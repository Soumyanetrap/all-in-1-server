...
const paylaod = {
    "name": "Soumyanetra Pal",
    "username": "Soumyanetra1",
    "email": "soumyanetrap@gmail.com",
    "password": "12345"
}
...
const tests = [
    // { method: 'POST', endpoint: '/auth/signup', body: paylaod, expected_type: 'object', expected: { message: 'success' }}
];
